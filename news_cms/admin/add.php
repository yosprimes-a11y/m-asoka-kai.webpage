...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image = $_POST['image'] ?? ''; // 画像パスはテキスト入力としておく
    ...
    if (empty($date) || empty($title) || empty($content)) {
        ...
        if (file_exists($news_file)) {
            ...
            if (!is_array($news_data)) { // JSONが不正な場合を考慮
                $news_data = [];
            }
        }
...
<head>
    ...
    <style>
        ...
        .form-group input[type="submit"] { background-color: #28a745; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; }
    ...
    <div class="container">
        ...
        <form action="add.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="url" name="url" placeholder="例: https://example.com/detail.html">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="image" name="image" placeholder="例: /news_cms/uploads/your_image.jpg" readonly>
            </div>
            <div class="form-group">
                <input type="submit" value="お知らせを追加">
            </div>
        </form>
    </div>
    <script>
        ...
        function uploadFile(file) {
            ...
            imagePathInput.value = ''; // アップロード中はパスをクリア
